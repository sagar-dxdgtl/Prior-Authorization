...
ROSTER = [
    ...
    # AZ BCBS = Blue Cross Blue Shield of Arizona (dba "AZ Blue"), an independent licensee — Stedi
    # payer 53589, eligibilityCheck=SUPPORTED. Validated live 2026-07-18 against this client's member
    # SRGB10057830 (active). Directory stays needs-authorized-api (BCBSAZ is not in the Elevance endpoint).
    ...
    ("Health Choice / BCBS / (Anthem / Elevance)", "Managed Medicaid", "AZ", "RP105", "needs_enrollment"),
    ("Healthspring", "Medicare Advantage", "AZ", "63092", "needs_enrollment"),
    ...
    # Stedi 86052 = "Mercy Care Plan (AZ Health Care Cost Containment System)" — the general AHCCCS
    # Medicaid product, eligibilityCheck=SUPPORTED. Validated live 2026-07-18 against this client's
    # member A48022150 (active); the earlier 33628 = "Mercy Care ACC-RBHA" is a different sub-product
    # and returned AAA-75 (not found) for this member.
    ("Mercy Care", "Managed Medicaid", "AZ", "86052", "needs_enrollment"),
    ("Mercy Care", "Medicare Advantage", "AZ", "86052", "needs_enrollment"),
    ("Molina Healthcare", "Dual Eligible (FIDE SNP)", "AZ", "A4353", "needs_enrollment"),
    ("Molina Healthcare", "Managed Medicaid", "AZ", "A4353", "needs_enrollment"),
    ...
    ("Wellcare (Centene)", "Medicare Advantage", "AZ", "68069", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Medicare Advantage", "AZ", "WLPNT", "needs_enrollment"),
    # --- Colorado (Denver) ---
    ...
    ("Healthspring", "Medicare Advantage", "CO-Denver", "63092", "needs_enrollment"),
    ("Humana", "Medicare Advantage", "CO-Denver", "61101", "supported"),
    # Stedi 100173 = "Kaiser Foundation Health Plan Colorado", eligibilityCheck=SUPPORTED. Validated
    # live 2026-07-18 (member 417958085 found; the AAA-71 was a DOB mismatch, so the id is correct).
    ("Kaiser Permanente", "Commercial", "CO-Denver", "100173", "needs_enrollment"),
    ("Kaiser Permanente", "Medicare Advantage", "CO-Denver", "100173", "needs_enrollment"),
    ...
    ("Align Senior Health Plan", "Medicare Advantage", "FL-South Florida", "ASFL1", "needs_enrollment"),
    ("Ambetter (Centene)", "ACA", "FL-South Florida", "68069", "needs_enrollment"),
    ("AmeriHealth Caritas", "ACA", "FL-South Florida", "88232", "needs_enrollment"),
    ("AmeriHealth Caritas", "Medicare Advantage", "FL-South Florida", "88232", "needs_enrollment"),
    ...
    ("Essence Healthcare", "Medicare Advantage", "IL", "20818", "needs_enrollment"),
    ("Humana", "Dual Eligible (FIDE SNP)", "IL", "61101", "supported"),
    ("Humana", "Medicare Advantage", "IL", "61101", "supported"),
    (
        "Illinois Department of Healthcare and Family Services (HFS)",
        "Traditional Medicaid", "IL", "IL621", "needs_enrollment",
    ),
    ...
    ("Provider Partners", "Medicare Advantage", "IL", "31401", "needs_enrollment"),
    ...
    ("Zing Health", "Medicare Advantage", "IL", "83248", "needs_enrollment"),
    ("Wellcare (Centene)", "Dual Eligible (FIDE SNP)", "IL", "68069", "needs_enrollment"),
    ("Wellcare (Centene)", "Medicare Advantage", "IL", "68069", "needs_enrollment"),
    ...
    ("BCBS / Empire (Anthem / Elevance)", "ACA", "GA-Atlanta", "00601", "needs_enrollment"),
    ("BCBS / Empire (Anthem / Elevance)", "Commercial", "GA-Atlanta", "00601", "needs_enrollment"),
    ("BCBS / Empire (Anthem / Elevance)", "Medicare Advantage", "GA-Atlanta", "00601", "needs_enrollment"),
    ("CareSource", "Medicare Advantage", "GA-Atlanta", "CRSCK", "needs_enrollment"),
    ...
    ("Healthspring", "Medicare Advantage", "GA-Atlanta", "63092", "needs_enrollment"),
    ("Humana", "Medicare Advantage", "GA-Atlanta", "61101", "supported"),
    ("Kaiser Foundation Health Plan of Georgia", "Medicare Advantage", "GA-Atlanta", "21313", "needs_enrollment"),
    ...
    ("Healthspring", "Medicare Advantage", "TX-Houston", "63092", "needs_enrollment"),
    ...
    ("Molina Healthcare", "ACA", "TX-Houston", "MLNTX", "needs_enrollment"),
    ("Molina Healthcare", "Managed Medicaid", "TX-Houston", "MLNTX", "needs_enrollment"),
    ("Molina Healthcare", "Medicare Advantage", "TX-Houston", "MLNTX", "needs_enrollment"),
    ("Novitas Solutions, Inc.", "Traditional Medicare", "TX-Houston", None, "needs_payer_id"),
    ("Oscar", "ACA", "TX-Houston", "OSCAR", "supported"),
    ("Superior HealthPlan (Centene)", "Managed Medicaid", "TX-Houston", "68069", "needs_enrollment"),
    (
        "Texas Health and Human Services Commission (HHSC)",
        "Traditional Medicaid", "TX-Houston", "86916", "needs_enrollment",
    ),
    ...
    ("Wellcare (Centene)", "Medicare Advantage", "TX-Houston", "68069", "needs_enrollment"),
    ("WellCare / AllWell (Centene)", "Dual Eligible (FIDE SNP)", "TX-Houston", "68069", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "ACA", "TX-Houston", "WLPNT", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Managed Medicaid", "TX-Houston", "WLPNT", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Medicare Advantage", "TX-Houston", "WLPNT", "needs_enrollment"),
    ...
    ("Healthspring", "Medicare Advantage", "TX-Dallas", "63092", "needs_enrollment"),
    ("Humana", "Medicare Advantage", "TX-Dallas", "61101", "supported"),
    ("Molina Healthcare", "ACA", "TX-Dallas", "MLNTX", "needs_enrollment"),
    ("Molina Healthcare", "Managed Medicaid", "TX-Dallas", "MLNTX", "needs_enrollment"),
    ("Molina Healthcare", "Medicare Advantage", "TX-Dallas", "MLNTX", "needs_enrollment"),
    ("Novitas Solutions, Inc.", "Traditional Medicare", "TX-Dallas", None, "needs_payer_id"),
    ("Superior HealthPlan (Centene)", "Managed Medicaid", "TX-Dallas", "68069", "needs_enrollment"),
    (
        "Texas Health and Human Services Commission (HHSC)",
        "Traditional Medicaid", "TX-Dallas", "86916", "needs_enrollment",
    ),
    ...
    ("Wellcare (Centene)", "Medicare Advantage", "TX-Dallas", "68069", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "ACA", "TX-Dallas", "WLPNT", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Managed Medicaid", "TX-Dallas", "WLPNT", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Medicare Advantage", "TX-Dallas", "WLPNT", "needs_enrollment"),
    ...
    # --- master-list reconciliation (2026-07-17) --------------------------------------------------
    # Reconciles the catalogue to the client's full market master list: adds the two entirely-new
    # markets FL-Tampa / NJ-UVC / NJ-Vascular Health, back-fills NY (was only Emblem+UMR) and
    # FL-South Florida, and the CO-Denver Clear Spring row. Known national ids reused verbatim
    # (Aetna 60054 / UHC 87726 / Humana 61101 / Cigna 62308 / Oscar OSCAR / Devoted DEVOT / Ambetter
    # 68069 / AvMed 59274 / Curative CURTV / First Coast FL 09102 / Aetna Better Health FL ABH01).
    # State-specific govt/regional ids are NOT reused across states (NGS-NY, Longevity-FL/NJ,
    # Novitas, the NJ/NY Medicaid agencies stay needs_payer_id — same honesty policy as the rest of
    # this file). Palmetto GBA "Traditional Medicaid" GA was intentionally dropped (already
    # corrected to Traditional Medicare above). 22 genuinely-new labels get needs_payer_id + a
    # SOURCES stub below (unsourced: directory_access "none" for govt/Medicaid, else
    # "needs-authorized-api"); real ids/directories pending research (see MATRIX.md).
    # CO-Denver
    ("Clear Spring Health", "Medicare Advantage", "CO-Denver", None, "needs_payer_id"),
    # Devoted Health added to its real client-market footprint that was missing (CO/IL/TX-Dallas —
    # Devoted already covers AZ/GA/FL/TX-Houston). NOT added to NJ/NY: Devoted does not sell there,
    # and a fabricated market row would false-resolve in a live demo. Same national id DEVOT / public
    # fhir.devoted.com adapter as the existing Devoted Health rows.
    ("Devoted Health", "Medicare Advantage", "CO-Denver", "DEVOT", "supported"),
    ("Devoted Health", "Medicare Advantage", "IL", "DEVOT", "supported"),
    ("Devoted Health", "Medicare Advantage", "TX-Dallas", "DEVOT", "supported"),
    # FL-South Florida
    ("Devoted Health", "Medicare Advantage", "FL-South Florida", "DEVOT", "supported"),
    ("Elevance Health - Simply", "Medicare Advantage", "FL-South Florida", "SMPLY", "needs_enrollment"),
    ("First Coast Service Options, Inc.", "Traditional Medicare", "FL-South Florida", "09102", "needs_enrollment"),
    ("First Health", "Commercial", "FL-South Florida", None, "needs_payer_id"),
    (
        "Florida Agency for Health Care Administration (AHCA)",
        "Traditional Medicaid", "FL-South Florida", "77027", "needs_enrollment",
    ),
    ("Gold Kidney Health Plan / Multiplan", "Medicare Advantage", "FL-South Florida", None, "needs_payer_id"),
    ("Healthspring", "Medicare Advantage", "FL-South Florida", "63092", "needs_enrollment"),
    ("Longevity Health Plan", "Medicare Advantage", "FL-South Florida", None, "needs_payer_id"),
    ("Molina Healthcare", "ACA", "FL-South Florida", "51062", "needs_enrollment"),
    ("Molina Healthcare", "Managed Medicaid", "FL-South Florida", "51062", "needs_enrollment"),
    ("Molina Healthcare", "Medicare Advantage", "FL-South Florida", "51062", "needs_enrollment"),
    ("Oscar", "ACA", "FL-South Florida", "OSCAR", "supported"),
    ("Partners Direct Health", "Commercial", "FL-South Florida", None, "needs_payer_id"),
    ("SECUR Health Plan", "Medicare Advantage", "FL-South Florida", None, "needs_payer_id"),
    ("Simply", "Managed Medicaid", "FL-South Florida", "SMPLY", "needs_enrollment"),
    ("Solis Health Plans (Athena Health Care)", "Medicare Advantage", "FL-South Florida", None, "needs_payer_id"),
    ("Sunshine State Health Plan (Centene)", "Managed Medicaid", "FL-South Florida", "68069", "needs_enrollment"),
    ("Ultimate Health Plans", "Medicare Advantage", "FL-South Florida", None, "needs_payer_id"),
    ("UnitedHealthcare", "Commercial", "FL-South Florida", "87726", "supported"),
    # New York
    ("Aetna", "Commercial", "NY", "60054", "needs_enrollment"),
    ("Aetna", "Medicare Advantage", "NY", "60054", "needs_enrollment"),
    ("Anthem / Empire BCBS (HealthPlus)", "ACA", "NY", "803", "needs_enrollment"),
    ("BCBS / Empire (Anthem / Elevance)", "Commercial", "NY", None, "needs_payer_id"),
    ("BCBS / Empire (Anthem / Elevance)", "Managed Medicaid", "NY", None, "needs_payer_id"),
    ("BCBS / Empire (Anthem / Elevance)", "Medicare Advantage", "NY", None, "needs_payer_id"),
    ("Cigna Healthcare", "Commercial", "NY", "62308", "needs_enrollment"),
    ("Humana", "Medicare Advantage", "NY", "61101", "supported"),
    ("National Government Services, Inc. (NGS)", "Traditional Medicare", "NY", None, "needs_payer_id"),
    ("New York State Department of Health (NYSDOH)", "Traditional Medicaid", "NY", "MCDNY", "needs_enrollment"),
    ("TRICARE", "VA", "NY", None, "needs_payer_id"),
    ("UnitedHealthcare", "Commercial", "NY", "87726", "supported"),
    ("UnitedHealthcare", "Medicare Advantage", "NY", "87726", "supported"),
    ("UnitedHealthcare Community Plan", "Managed Medicaid", "NY", None, "needs_payer_id"),
    # --- Florida (Tampa) --- new market
    ("Aetna", "Commercial", "FL-Tampa", "60054", "needs_enrollment"),
    ("Aetna", "Medicare Advantage", "FL-Tampa", "60054", "needs_enrollment"),
    ("Aetna Better Health", "Managed Medicaid", "FL-Tampa", "ABH01", "needs_enrollment"),
    ("Align Senior Health Plan", "Medicare Advantage", "FL-Tampa", "ASFL1", "needs_enrollment"),
    ("Ambetter (Centene)", "ACA", "FL-Tampa", "68069", "needs_enrollment"),
    ("AmeriHealth Caritas", "ACA", "FL-Tampa", "88232", "needs_enrollment"),
    ("AvMed", "ACA", "FL-Tampa", "59274", "needs_enrollment"),
    ("AvMed", "Commercial", "FL-Tampa", "59274", "needs_enrollment"),
    ("BCBS / Empire (Anthem / Elevance)", "ACA", "FL-Tampa", None, "needs_payer_id"),
    ("BCBS / Empire (Anthem / Elevance)", "Commercial", "FL-Tampa", None, "needs_payer_id"),
    ("BCBS / Empire (Anthem / Elevance)", "Managed Medicaid", "FL-Tampa", None, "needs_payer_id"),
    ("BCBS / Empire (Anthem / Elevance)", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("Cigna Healthcare", "ACA", "FL-Tampa", "62308", "needs_enrollment"),
    ("Cigna Healthcare", "Commercial", "FL-Tampa", "62308", "needs_enrollment"),
    ("Community Care Plan", "Managed Medicaid", "FL-Tampa", None, "needs_payer_id"),
    ("Curative", "Commercial", "FL-Tampa", "CURTV", "needs_enrollment"),
    ("Devoted Health", "Medicare Advantage", "FL-Tampa", "DEVOT", "supported"),
    ("Elevance Health - Simply", "Medicare Advantage", "FL-Tampa", "SMPLY", "needs_enrollment"),
    ("First Coast Service Options, Inc.", "Traditional Medicare", "FL-Tampa", "09102", "needs_enrollment"),
    ("First Health", "Commercial", "FL-Tampa", None, "needs_payer_id"),
    (
        "Florida Agency for Health Care Administration (AHCA)",
        "Traditional Medicaid", "FL-Tampa", "77027", "needs_enrollment",
    ),
    ("Gold Kidney Health Plan / Multiplan", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("Healthspring", "Medicare Advantage", "FL-Tampa", "63092", "needs_enrollment"),
    ("Longevity Health Plan", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("Molina Healthcare", "ACA", "FL-Tampa", "51062", "needs_enrollment"),
    ("Molina Healthcare", "Managed Medicaid", "FL-Tampa", "51062", "needs_enrollment"),
    ("Molina Healthcare", "Medicare Advantage", "FL-Tampa", "51062", "needs_enrollment"),
    ("Oscar", "ACA", "FL-Tampa", "OSCAR", "supported"),
    ("Partners Direct Health", "Commercial", "FL-Tampa", None, "needs_payer_id"),
    ("SECUR Health Plan", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("Simply", "Managed Medicaid", "FL-Tampa", "SMPLY", "needs_enrollment"),
    ("Solis Health Plans (Athena Health Care)", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("Sunshine State Health Plan (Centene)", "Managed Medicaid", "FL-Tampa", "68069", "needs_enrollment"),
    ("Ultimate Health Plans", "Medicare Advantage", "FL-Tampa", None, "needs_payer_id"),
    ("UnitedHealthcare", "Commercial", "FL-Tampa", "87726", "supported"),
    ("Baycare", "Medicare Advantage", "FL-Tampa", "81079", "needs_enrollment"),
    # --- New Jersey (UVC) --- new market
    ("Aetna", "Commercial", "NJ-UVC", "60054", "needs_enrollment"),
    ("Aetna", "Medicare Advantage", "NJ-UVC", "60054", "needs_enrollment"),
    ("BCBS / Horizon (Anthem / Elevance)(HCSC)", "Managed Medicaid", "NJ-UVC", "22099", "needs_enrollment"),
    ("Cigna Healthcare", "Commercial", "NJ-UVC", "62308", "needs_enrollment"),
    ("Claritev", "Commercial", "NJ-UVC", None, "needs_payer_id"),
    (
        "New Jersey Department of Human Services - Division of Medical Assistance and Health Services (DMAHS)",
        "Traditional Medicaid", "NJ-UVC", "100229", "needs_enrollment",
    ),
    ("Novitas Solutions, Inc.", "Traditional Medicare", "NJ-UVC", None, "needs_payer_id"),
    ("UnitedHealthcare", "ACA", "NJ-UVC", "87726", "supported"),
    ("UnitedHealthcare", "Commercial", "NJ-UVC", "87726", "supported"),
    # --- New Jersey (Vascular Health) --- new market
    ("Aetna", "Commercial", "NJ-Vascular Health", "60054", "needs_enrollment"),
    ("Aetna", "Medicare Advantage", "NJ-Vascular Health", "60054", "needs_enrollment"),
    ("Ambetter (Centene) / Fidelis", "ACA", "NJ-Vascular Health", "68069", "needs_enrollment"),
    ("AmeriHealth NJ", "ACA", "NJ-Vascular Health", "95044", "needs_enrollment"),
    ("AmeriHealth NJ", "Commercial", "NJ-Vascular Health", "95044", "needs_enrollment"),
    ("AmeriHealth NJ", "Medicare Advantage", "NJ-Vascular Health", "95044", "needs_enrollment"),
    (
        "BCBS / Braven (Anthem / Elevance)(HCSC)",
        "Medicare Advantage", "NJ-Vascular Health", "84367", "needs_enrollment",
    ),
    ("BCBS / Horizon (Anthem / Elevance)(HCSC)", "ACA", "NJ-Vascular Health", "22099", "needs_enrollment"),
    ("BCBS / Horizon (Anthem / Elevance)(HCSC)", "Commercial", "NJ-Vascular Health", "22099", "needs_enrollment"),
    ("BCBS / Horizon (Anthem / Elevance)(HCSC)", "Managed Medicaid", "NJ-Vascular Health", "22099", "needs_enrollment"),
    (
        "BCBS / Horizon (Anthem / Elevance)(HCSC)",
        "Medicare Advantage", "NJ-Vascular Health", "22099", "needs_enrollment",
    ),
    ("Claritev", "Commercial", "NJ-Vascular Health", None, "needs_payer_id"),
    ("Clover Health", "Medicare Advantage", "NJ-Vascular Health", "CRPHP", "needs_enrollment"),
    ("Healthspring", "Medicare Advantage", "NJ-Vascular Health", "63092", "needs_enrollment"),
    ("Humana", "Medicare Advantage", "NJ-Vascular Health", "61101", "supported"),
    ("Longevity Health Plan", "Medicare Advantage", "NJ-Vascular Health", None, "needs_payer_id"),
    (
        "New Jersey Department of Human Services - Division of Medical Assistance and Health Services (DMAHS)",
        "Traditional Medicaid", "NJ-Vascular Health", "100229", "needs_enrollment",
    ),
    ("Novitas Solutions, Inc.", "Traditional Medicare", "NJ-Vascular Health", None, "needs_payer_id"),
    ("Oscar", "ACA", "NJ-Vascular Health", "OSCAR", "supported"),
    ("UnitedHealthcare", "ACA", "NJ-Vascular Health", "87726", "supported"),
    ("UnitedHealthcare", "Commercial", "NJ-Vascular Health", "87726", "supported"),
    ("UnitedHealthcare", "Medicare Advantage", "NJ-Vascular Health", "87726", "supported"),
    ("UnitedHealthcare Community Plan", "Managed Medicaid", "NJ-Vascular Health", "86047", "needs_enrollment"),
    ("Wellcare (Centene) / Fidelis", "Managed Medicaid", "NJ-Vascular Health", "68069", "needs_enrollment"),
    ("Wellcare (Centene) / Fidelis", "Medicare Advantage", "NJ-Vascular Health", "68069", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Managed Medicaid", "NJ-Vascular Health", "WLPNT", "needs_enrollment"),
    ("Wellpoint / Amerigroup (Elevance)", "Medicare Advantage", "NJ-Vascular Health", "WLPNT", "needs_enrollment"),
]
...
SOURCES: dict[str, tuple[str | None, str | None, str | None, str]] = {
    ...
    # --- master-list reconciliation (2026-07-17): new labels, not yet sourced ---------------------
    # Stubs only: no verified FHIR/TiC/directory yet, so directory_access is "none" for government/
    # Medicaid agencies (the program IS the network) and "needs-authorized-api" for the rest. Real
    # endpoints + Stedi ids are pending research (MATRIX.md); until then these resolve in the picker
    # (roster search) and, where an id is later confirmed, flip needs_payer_id -> needs_enrollment.
    "Ambetter (Centene) / Fidelis": (None, None, None, "needs-authorized-api"),
    "AmeriHealth NJ": (None, None, None, "needs-authorized-api"),
    "Anthem / Empire BCBS (HealthPlus)": (None, None, None, "needs-authorized-api"),
    "BCBS / Braven (Anthem / Elevance)(HCSC)": (None, None, None, "needs-authorized-api"),
    "BCBS / Horizon (Anthem / Elevance)(HCSC)": (None, None, None, "needs-authorized-api"),
    "Baycare": (None, None, None, "needs-authorized-api"),
    "Claritev": (None, None, None, "needs-authorized-api"),
    "Clover Health": (None, None, None, "needs-authorized-api"),
    "Elevance Health - Simply": (None, None, None, "needs-authorized-api"),
    "First Health": (None, None, None, "needs-authorized-api"),
    "Florida Agency for Health Care Administration (AHCA)": (None, None, None, "none"),
    "Gold Kidney Health Plan / Multiplan": (None, None, None, "needs-authorized-api"),
    "New Jersey Department of Human Services - Division of Medical Assistance and Health Services (DMAHS)": (
        None, None, None, "none",
    ),
    "New York State Department of Health (NYSDOH)": (None, None, None, "none"),
    "Partners Direct Health": (None, None, None, "needs-authorized-api"),
    "SECUR Health Plan": (None, None, None, "needs-authorized-api"),
    "Simply": (None, None, None, "needs-authorized-api"),
    "Solis Health Plans (Athena Health Care)": (None, None, None, "needs-authorized-api"),
    "Sunshine State Health Plan (Centene)": (None, None, None, "needs-authorized-api"),
    "TRICARE": (None, None, None, "none"),
    "Ultimate Health Plans": (None, None, None, "needs-authorized-api"),
    "Wellcare (Centene) / Fidelis": (None, None, None, "needs-authorized-api"),
}
