...
- ☐ ⛔ **locate index** — **Aetna TiC**: old HealthSparq CDN decommissioned; find the current *public* fully-insured index (re-hunt was in progress). TiC is federally mandated, so it exists.
